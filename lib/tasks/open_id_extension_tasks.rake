namespace :radiant do
  namespace :extensions do
    namespace :open_id do
      ...
      desc "Runs the migration of the Open extension"
      task :migrate => :environment do
        require 'radiant/extension_migrator'
        if ENV["VERSION"]
          OpenExtension.migrator.migrate(ENV["VERSION"].to_i)
        else
          OpenExtension.migrator.migrate
        end
      end
      ...
      task :update => :environment do
        ...
        puts "Copying assets from OpenExtension"
